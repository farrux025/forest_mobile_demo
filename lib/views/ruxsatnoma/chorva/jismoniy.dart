...
class PetFeedingNoLegalScreen extends StatefulWidget {
  const PetFeedingNoLegalScreen({Key? key}) : super(key: key);

  @override
  State<PetFeedingNoLegalScreen> createState() =>
      _PetFeedingNoLegalScreenState();
}

class _PetFeedingNoLegalScreenState extends State<PetFeedingNoLegalScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: appBar("Chorva mollarini boqish (jismoniy shaxs)"),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        editText(
                            initialValue: "59996655774412",
                            readOnly: true,
                            maxLines: 1),
                        titleEditText(title: "Passport seriya va raqami"),
                        editText(initialValue: "AC5478962", readOnly: true),
